...
export const MOCK_LABS: MockLab[] = [
  ...
  },
  {
    ...
    description:
      "AI 시대에 교육과 리더십은 어떻게 달라져야 할까요. AI 테크에듀 LAB은 기술을 단순한 수업 보조용 부가 도구(EdTech)에 머무르게 하지 않고, 교육·경영의 과제를 다시 설계하는 동력으로 다룹니다. 원우는 첨단 AI의 원리와 방법을 횡단적으로 익히고, 진로·진학·학습관리·에듀비즈니스 등 종단적 현장 맥락에 접목해 스스로 해법을 설계하는 역량을 기릅니다.\n\n" +
      "동시에 린 스타트업(가설–실험–측정–학습)과 애자일 조직 운영의 리듬, OKR로 방향·우선순위·성과를 정렬하는 방법, 디자인 씽킹으로 이해관계자 관점에서 문제를 재정의하는 흐름을 병행해 다룹니다. AI·데이터는 이 프레임 안에서 ‘빠르게 배우고 바꿀 수 있는 조직’을 만드는 촉매로 위치합니다. 학원·교육 서비스의 제품·운영·상담·콘텐츠를 하나의 성장 루프로 묶어 스케일업을 설계하고, 장기적으로는 교육 분야에서 반복 가능한 고성장 모델을 완성해 유니콘급 기업으로 도약할 수 있는 전략적 사고까지 확장하는 것을 지향합니다.\n\n" +
...
export const MOCK_FAQ: MockFaq[] = [
  ...
  },
  {
    ...
    answer:
      "진로·진학·학습관리·에듀비즈니스 등 적용 도메인(종단)과 바이브 코딩, 프롬프트, RAG, 파인튜닝, 에이전트, 지식 하네스, 지식 온톨로지 등 기술 축(횡단)을 교차해 프로젝트를 설계합니다. 여기에 린 스타트업, 애자일 조직 운영, OKR, 디자인 씽킹을 병행해 학원·교육 사업의 성장 루프와 스케일업·고성장 전략까지 연결합니다. LAB 상세 페이지의 매트릭스와 개설 과목 안내를 함께 참고해 주세요.",
  },
  {
    id: "f19",
    category: "논문/연구",
